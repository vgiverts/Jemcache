 ...
 *
 * This class was copied from java.util.concurrent.ConcurrentLinkedQueue so that it could be extended.
 */
public class ConcurrentLinkedQueue<E> extends AbstractQueue<E> implements Queue<E>, java.io.Serializable {
    ...
    public static class Node<E> {
        ...
        public E getAndSetItem(E val) {
            return (E) itemUpdater.getAndSet(this, val);
        }
